...
local function APL()
  ...
  Cds = function()
    ...
    if I.VariableIntensityGigavoltOscillatingReactor:IsReady() and (Player:HasHeroism() or Target:TimeToDie() <= 20 or Player:ComboPointsDeficit() <= 2) then
      if HR.CastSuggested(I.VariableIntensityGigavoltOscillatingReactor) then return "variable_intensity_gigavolt_oscillating_reactor 34"; end
    end
    -- blood_fury
